      ...
      <main className="px-10 bg-white md:px-20 lg:px-40 dark:bg-black">
        <section className="min-h-screen">
          ...
          <navbar className="py-8 mb-12 flex justify-between dark:text-white">
            <h1 className="text-3xl font-bold text-black dark:text-white lg:text-4xl">YA</h1>
            <ul className="flex item-center">
              ...
              <li><a className="bg-transparent border-solid border-[#0FF0FC] border-2 dark:text-white px-4 py-2 rounded-md ml-8 font-semibold hover:shadow-alpha" href='https://drive.google.com/file/d/1A6LMwrmheRPTK70GBmk6xj3wqXkpNY4b/view?usp=sharing' target="_blank">Degree</a></li>
              <li><a className="bg-transparent border-solid border-[#0FF0FC] border-2 dark:text-white px-4 py-2 rounded-md ml-8 font-semibold hover:shadow-alpha" href='https://drive.google.com/file/d/1wsJM_FAltHEt8a35tF7KsXLUpLUSrbyo/view?usp=sharing' target="_blank">CV</a></li>
            </ul>
          </navbar>
          <div className="text-center p-10 py-10">
            <h2 className="text-5xl py-1 bg-gradient-to-r from-blue-600 via-red-500 to-indigo-400 inline-block text-transparent bg-clip-text font-medium md:text-6xl md:whitespace-nowrap lg:whitespace-nowrap">Youssef Ashraf</h2>
            <h3 className="uppercase text-2xl py-1 md:text-5xl md:py-3 dark:text-white">Developer And Designer</h3>
            <h4 className="text-xl md:text-3xl dark:text-white ">Junior Front End Developer</h4>
          </div>
          </div>
        ...
        <section>
          ...
          <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
            ...
            <ul>
            <p className="text-cyan-800 py-1 underline">Databases</p>
          ...
          {/* FIRST PROJECT: AlphaX */}
            <div className="basis-1/4 flex-1  min-h-[570px] overflow-hidden rounded-2xl shadow-2xl flex flex-col justify-between w-full bg-white hover:scale-105 transition-all duration-500">
              ...
              <div class="flex flex-col justify-between items-start flex-1 p-[20px]">
                <h1 class="mb-4 font-medium text-start text-xl md:text-2xl">AlphaX (Netflix Clone)</h1>
                <p class="flex-1 mb-3 text-black text-start font-light text-md md:text-lg">
                Have you ever found yourself endlessly scrolling through various streaming platforms, desperately searching for something new and exciting to watch? Well, fret no more because AlphaX is here to save the day! 
                It's like Netflix but with a twist. This app is designed specifically to cater to your unique tastes and preferences, offering a vast range of shows and movies that are hand-picked just for you. 
                With its intuitive interface and advanced algorithm, AlphaX ensures that you'll never run out of quality entertainment options. 
                Whether you're into heart-stopping thrillers or heartwarming rom-coms, this app has got you covered. Plus, it constantly updates its library with the latest releases from around the world, 
                so you'll always be ahead of the curve. Say goodbye to aimless scrolling and hello to AlphaX - your new best friend in the world of streaming!
                </p>
            ...
            <div className="basis-1/4 flex-1 min-h-[570px] overflow-hidden rounded-2xl shadow-2xl flex flex-col justify-between w-full bg-white hover:scale-105 transition-all duration-500">
              ...
              We're talking about some of the most comprehensive databases that compile all the mind-blowing celestial knowledge in one place that can easily be accessed with <span className='font-bold'>NASA API</span>.
              ...
              {/* THIRD PROJECT: To Do List (Harry Potter Edition) */}
            <div className="basis-1/4 flex-1 min-h-[570px] overflow-hidden rounded-2xl shadow-2xl flex flex-col justify-between w-full bg-white hover:scale-105 transition-all duration-500">
            ...
            <div className="basis-1/4 flex-1 min-h-[570px] overflow-hidden rounded-2xl shadow-2xl flex flex-col justify-between w-full bg-white hover:scale-105 transition-all duration-500">
              ...
              <div class="flex flex-col justify-between items-start flex-1 p-[20px]">
                ...
                <p class="flex-1 mb-3 text-black text-start font-light text-md md:text-lg">It's like having your own personal meteorologist in the palm of your hand! 
                This nifty little app gives you detailed and accurate weather forecasts using the <span className='font-bold'>OpenWeatherMap API</span> for not just your current location, but also for any city or town around the globe. 
                It provides real-time updates on temperature, humidity levels, wind speed, and even precipitation chances. The user interface is clean and intuitive, 
                making it a breeze to navigate through all the information.
                </p>
            ...
            {/* FIFTH PROJECT: The Valley of Fear */}
            <div className="basis-1/4 flex-1 min-h-[570px] overflow-hidden rounded-2xl shadow-2xl flex flex-col justify-between w-full bg-white hover:scale-105 transition-all duration-500">
            ...
            {/* SIXTH PROJECT: Online Library Management System */}
